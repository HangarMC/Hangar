...
public record Traits(String email, String github, String discord, String language, String username, String theme) {
    ...
    @JsonCreator
    public Traits(final @NotNull String email, final String github, final String discord, final String language, final @NotNull String username, final String theme) {
        this.email = email;
