...
public class PluginDependency implements Named, Comparable<PluginDependency> {
    ...
    private final @Validate(SpEL = "@validate.regex(#root, @'hangar-io.papermc.hangar.config.hangar.HangarConfig'.urlRegex)", message = "fieldError.url") @Nullable String externalUrl;
