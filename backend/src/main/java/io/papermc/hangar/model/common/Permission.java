...
public class Permission implements Comparable<Permission>, Argument {
    ...
    public static final Permission IsOrganizationAdmin = new Permission(EditOrganizationSettings.value | ManageOrganizationMembers.value | IsOrganizationMember.value | IsProjectOwner.value);
    public static final Permission IsOrganizationOwner = new Permission(DeleteOrganization.value | IsOrganizationAdmin.value);
