...
export default defineConfig({
  ...
  shortcuts: {
    ...
    "button-secondary": "bg-charcoal-600 enabled:hover:(bg-gray-800 border-gray-700)",
    "button-transparent": "bg-transparent border border-transparent enabled:hover:(bg-gray-800 border-gray-700)",
