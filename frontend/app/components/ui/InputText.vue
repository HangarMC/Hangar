...
<template>
  ...
  >
    <template #default="slotProps">
      <input v-model="value" class="ml-4 focus:outline-none" type="text" v-bind="$attrs" :maxlength="maxlength" :class="slotProps.class" :disabled :readonly="isReadonly" @input="v.$touch" />
    </template>
    <!-- @vue-ignore -->
