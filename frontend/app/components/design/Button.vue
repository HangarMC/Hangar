...
const classes = computed<string>(() => {
  ...
  return (
    "rounded-2xl font-semibold inline-flex items-center justify-center border-1 border-gray-800 hover:scale-[1.005] hover:bg-gray-700 transition-all duration-250" +
