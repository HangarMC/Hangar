    ...
    <template #header>
      <div class="flex items-center justify-between">
        ...
        <button
          ...
          @click="toggle"
        >
        <span class="ml-1 text-sm text-gray-400 border border-transparent hover:bg-gray-800 hover:border-gray-700 p-0.5 rounded-full transition-all duration-250 hover:scale-[1.015]">
