...
const msgs: LocaleMessageObject = {
    ...
    page: {
        ...
        new: {
            ...
            name: 'Nom de la page',
            parent: "Page d'origine (optionel)",
        },
        delete: {
    ...
    version: {
        new: {
            ...
            error: {
                ...
                invalidPluginDependencyNamespace: 'La dépendance du plugin déclarée a un espace dans le nom le rendant invalide',
                channel: {
        ...
        page: {
            ...
            platform: 'Plateforme',
            required: '(requis)',
            adminMsg: '{0} approva cette version le {1}',
            reviewLogs: "Journaux de l'examen",
            ...
            downloadExternal: 'Télécharger externellement',
            adminActions: 'Actions administrateur',
            recommended: 'Version recommandée',
            partiallyApproved: 'Partiellement apprové',
            approved: 'Apprové',
    ...
    channel: {
        ...
        manage: {
            ...
            subtitle: "Les canaux de diffusion représentent l'état d'une version d'une plugin... Un projet pourrait avoir jusqu'à cinq canaux de diffusion.",
    ...
    notifications: {
        ...
        empty: {
            unread: "Vous n'avez aucune notifications nonlue.",
