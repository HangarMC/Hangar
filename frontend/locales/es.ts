...
const msgs: LocaleMessageObject = {
    ...
    project: {
        stargazers: 'Stargazers', //To be checked
        noStargazers: 'Todavía no hay stargazers en este proyecto 😢', // To be checked
        watchers: 'Notificados', // To be checked
        noWatchers: 'Todavía no hay notificados en este proyecto 😢', // To be checked
        members: 'Miembros',
        category: {
            info: 'Categoría: {0}',
        ...
        actions: {
            ...
            watch: 'Seguir',
            flag: 'Marcar',
            star: 'Star', // To be checked
            unstar: 'Unstar', // To be checked
        ...
        new: {
            ...
            step3: {
                ...
                issues: 'Sistema de issues', // To be checked
                source: 'Código fuente',
        ...
        info: {
            ...
            watchers: '0 watchers | {0} watcher | {0} watchers', // To be checked
        },
        promotedVersions: 'Versiones promovidas', // To be checked
        license: {
