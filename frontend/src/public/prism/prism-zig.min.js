!(function (e) {
  ...
  var r =
    ...
    s =
      "(?!\\s)(?:!?\\s*(?:" +
      "(?:\\?|\\bpromise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*<ALIGN>|\\s*const\\b|\\s*volatile\\b|\\s*allowzero\\b)*)".replace(/<ALIGN>/g, n(o)) +
      "\\s*)*" +
  ...
  (e.languages.zig = {
    ...
    "class-name": [
      ...
      { pattern: RegExp("(\\)\\s*)<TYPE>(?=\\s*(?:<ALIGN>\\s*)?;)".replace(/<TYPE>/g, n(s)).replace(/<ALIGN>/g, n(o))), lookbehind: !0, inside: null },
    ],
    "builtin-type": {
      pattern:
