!(function (e) {
  ...
  (e.languages.java = e.languages.extend("clike", {
    ...
    "class-name": [
      s,
      { pattern: RegExp("(^|[^\\w.])" + t + "[A-Z]\\w*(?=\\s+\\w+\\s*[;,=()]|\\s*(?:\\[[\\s,]*\\]\\s*)?::\\s*new\\b)"), lookbehind: !0, inside: s.inside },
      {
    ...
    e.languages.insertBefore("java", "class-name", {
      ...
      import: [
        ...
        },
        {
          ...
          lookbehind: !0,
          alias: "static",
          inside: { namespace: s.inside.namespace, static: /\b\w+$/, punctuation: /\./, operator: /\*/, "class-name": /\w+/ },
        },
      ],
      namespace: {
        pattern: RegExp(
