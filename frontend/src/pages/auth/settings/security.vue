    ...
    <div v-else class="flex lt-sm:flex-col gap-8">
      <div class="flex flex-col gap-2 basis-1/2">
        ...
        <div class="mt-auto flex flex-col gap-2">
          <p>Enter a one time code generated by your authenticator app in the box below.</p>
          <InputText v-model="totpCode" label="One Time Code" inputmode="numeric" :rules="[requiredIf()(() => totpData != undefined)]" />
          <Button :disabled="loading || v.$invalid" @click="addTotp">Verify code and activate</Button>
        </div>
      </div>
      <div class="basis-1/2">
