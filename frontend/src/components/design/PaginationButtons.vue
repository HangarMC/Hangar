...
<template>
  <div class="flex gap-1.5 justify-center rounded-md h-10">
    <Button class="bg-charcoal-500 py-2 w-10 h-full" :disabled="page <= 0" aria-label="First page" @click="gotoPage(0)">
      <IconMdiChevronDoubleLeft />
    </Button>
    <Button class="bg-charcoal-500 py-2 w-10 h-full" :disabled="page <= 0" aria-label="Prev page" @click="gotoPage(page - 1)">
      <IconMdiChevronLeft />
    </Button>
    <Button
      ...
      class="bg-transparent w-10 h-full"
    ...
    <Button
      class="bg-charcoal-500 w-10 py-2 h-full"
