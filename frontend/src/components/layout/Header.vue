...
<template>
  <header class="max-w-screen-2xl mx-auto">
    <div v-if="useBackendData.announcements" class="-px-100 w-full">
      <Announcement  v-for="(announcement, idx) in useBackendData.announcements" :key="idx" class="my-2 mx-8" :announcement="announcement" />
    </div>
    <!-- Navbar -->
