...
import me.minidigger.hangar.service.plugindata.handler.PaperPluginFileHandler;
import me.minidigger.hangar.service.plugindata.handler.VelocityFileHandler;
import me.minidigger.hangar.service.plugindata.handler.WaterfallPluginFileHandler;
...
class PluginDataServiceTest {
    ...
    private static final Path path = Path.of("src/test/resources/me/minidigger/hangar/service/plugindata");
