...
public interface ProjectsDAO {
    ...
    @DefineNamedBindings
    <T extends Project> List<T> getProjects(String owner, String slug, @Define boolean seeHidden, Long requesterId, String orderBy,
                                            ...
                                            String query, @Define String queryStatement, long limit, long offset, @MapTo Class<T> type);
