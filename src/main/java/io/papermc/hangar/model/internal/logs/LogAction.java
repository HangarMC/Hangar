...
public class LogAction<LC extends LogContext<? extends LoggedActionTable, LC>> {
    ...
    // public static final LogAction<VersionContext> VERSION_PLATFORM_DEPENDENCY_CHANGED = new LogAction<>(PGLoggedAction.VERSION_PLATFORM_DEPENDENCY_CHANGED, "Version Platform Dependency Changed");  // TODO add to sql
