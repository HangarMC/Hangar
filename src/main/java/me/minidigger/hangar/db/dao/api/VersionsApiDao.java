...
public interface VersionsApiDao {
    ...
    Version getVersion(String pluginId, String versionString, @Define boolean canSeeHidden, @Define Long userId);
    ...
    List<Version> listVersions(String pluginId, @BindList(value = "tags", onEmpty = EmptyHandling.NULL_VALUE) List<String> tags, @Define boolean canSeeHidden, Long limit, long offset, @Define Long userId);
