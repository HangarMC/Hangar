...
public interface PermissionsDao {
    ...
    @SqlQuery("SELECT permission::BIGINT perm_value FROM project_trust pt JOIN users u ON pt.user_id = u.id WHERE pt.user_id = :userId AND pt.project_id = :projectId")
