        ...
        <template v-slot:modal-content>
            ...
            <div class="modal-body">
                ...
                <form action="https://sandbox.paypal.com/cgi-bin/webscr" method="post" @submit="popup($el)">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <button type="button" @click="amount = 10" :class="'btn ' + (amount === 10 ? 'btn-primary' : 'btn-default')">$10</button>
                            <button type="button" @click="amount = 20" :class="'btn ' + (amount === 20 ? 'btn-primary' : 'btn-default')">$20</button>
                            <button type="button" @click="amount = 30" :class="'btn ' + (amount === 30 ? 'btn-primary' : 'btn-default')">$30</button>
                        </div>
                    </div>
